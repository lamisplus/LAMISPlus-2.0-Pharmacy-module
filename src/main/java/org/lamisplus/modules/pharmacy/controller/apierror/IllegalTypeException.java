...
public class IllegalTypeException extends RuntimeException {
    ...
    public IllegalTypeException(Class clazz, String... searchParamsMap) {
        super(org.lamisplus.modules.pharmacy.controller.apierror.IllegalTypeException.generateMessage(clazz.getSimpleName(), ErrorMapper.toMap(String.class, String.class, searchParamsMap)));
    }
